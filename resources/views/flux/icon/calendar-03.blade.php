...
{{-- Hugeicons Free 4.3.5 · «calendar-03» · MIT, Copyright (c) 2025 Hugeicons · generado con `php artisan pj:iconos` --}}
...
<svg
    ...
    data-slot="icon"
>
    <path d="M16 2V6M8 2V6" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
