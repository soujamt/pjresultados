...
{{-- Hugeicons Free 4.3.5 · «square-lock-02» · MIT, Copyright (c) 2025 Hugeicons · generado con `php artisan pj:iconos` --}}
...
<svg
    ...
    data-slot="icon"
>
    <path d="M12 14.5V17.5M13 14.5C13 15.0523 12.5523 15.5 12 15.5C11.4477 15.5 11 15.0523 11 14.5C11 13.9477 11.4477 13.5 12 13.5C12.5523 13.5 13 13.9477 13 14.5Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M16.5 9V6.5C16.5 4.01472 14.4853 2 12 2C9.51471 2 7.49999 4.01472 7.49999 6.5V9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
