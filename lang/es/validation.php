...
return [
    ...
    */
    ...
    // 'password' es un ARRAY desde Laravel 9: son los mensajes de la regla
    // Password::defaults(). Cuando estaba como cadena, la búsqueda anidada de
    // validation.password.uncompromised no resolvía y el usuario veía la clave
    // cruda en pantalla. La comprobación de "contraseña actual" pasó a
    // llamarse current_password.
    'password' => [
        ...
        // Se dice qué hacer y no solo que está mal: sin esa guía, la persona
        // reintenta con variantes del mismo patrón (palabra + números) que
        // también están en las filtraciones, y se frustra probando de a una.
        'uncompromised' => 'Esta :attribute apareció en una filtración de datos conocida. Pruebe con una frase de tres o cuatro palabras sin relación entre sí: es más segura y más fácil de recordar.',
    ],
