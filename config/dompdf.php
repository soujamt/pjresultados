...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * Activado: sin esto cada PDF incrusta la fuente DejaVu completa y un
         * documento de una hoja pasa de ~16 KB a ~880 KB.
         */
         ...
         *
         * DejaVu Sans viene con dompdf y cubre las tildes y la ñ de los
         * apellidos sin depender de las fuentes del servidor.
         *
         * @var string
         */
